 ...
 * [CommFragment.OnFragmentInteractionListener] interface
...
class CommFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_comm, container, false)

        root.findViewById<Button>(R.id.comm).setOnClickListener {
